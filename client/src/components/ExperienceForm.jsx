    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1 bg-purple-100
        text-purple-700 rounded hover:bg-purple-200 transition-all
        "
        >
      ...
      {data.length === 0 ? (
        <div className='text-center py-8 text-gray-500'>
            ...
            <p>No work exprience added yet.</p>
            <p className="text-sm">Click "Add Exprience" to get started.</p>
        </div>
      ) :(
                ...
                space-y-3">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            disabled:opacity-50">
                              {genratingIndex === index ? (<Loader className="size-4 animate-spin"/>):(<Sparkles className="w-3 h-3"/>)}
                               Enhance with AI
                        ...
                        placeholder="Describe your key responsibilties and achievement..." />
                    </div>
                </div>
            ))}
        </div>
