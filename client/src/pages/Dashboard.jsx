    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <PlusIcon
              className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-r 
            from-indigo-300 to-indigo-500 text-white rounded-full "
            />
            <p
              className="text-sm group-hover:text-indigo-300 transition-all
            duration-300"
            >
              Create Resume
            </p>
          ...
          >
            <UploadCloudIcon
              className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-r 
            from-purple-300 to-purple-500 text-white rounded-full "
            />
            <p
              className="text-sm group-hover:text-purple-300 transition-all
            duration-300"
            >
              Upload Existing
            </p>
        ...
        {showCreateResume && (
          ...
          >
            ...
            >
              <h2 className="font-bold  mb-2">Create a resume</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
                className="w-full px-4 py-2 mb-4 focus:border-[#1e3a8a] ring-[#1e3a8a]"
                placeholder="Enter resume title"
                required
              />
              <button
                className=" w-full py-2 bg-[#2563eb] text-white rounded 
                hover:bg-[#5380e0] "
              >
                Create Resume
              </button>
        ...
        {showUploadResume && (
          ...
          >
            ...
            >
                ...
                >
                  ...
                  <div
                    className="flex flex-col items-center justify-center gap-2
                      ...
                      rounded-md p-4 py-10 my-4 hover:border-[#547be6] hover:text-[#1e3a8a] cursor-pointer
                      transition-colors"
                  >
                    {resume ? (
                      <p className="text-[#1e3a8a]">{resume.name}</p>
                    ) : (
                      <>
              ...
              <button
              disabled={isLoading}
                className="flex items-center justify-center gap-2 w-full py-2 bg-[#2563eb] text-white rounded 
                hover:bg-[#5380e0] "
              >
                {isLoading && (
        ...
        {editResumeId && (
          ...
          >
            <div
              ...
              rounded-lg w-full max-w-sm p-6"
            >
              <h2 className="font-bold  mb-2">Edit Resume Title</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
